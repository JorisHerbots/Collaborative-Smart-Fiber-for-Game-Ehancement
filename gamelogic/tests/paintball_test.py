...
def test_players_registration():
    ...
    paintball.engine.initiate_event("entity_registered", {"entity": {"ipv4_address": 0}})
    paintball.engine.initiate_event("entity_registered", {"entity": {"ipv4_address": 1}})
    time.sleep(1)
...
def test_team_communication():
    ...
    paintball.engine.initiate_event("entity_registered", {"entity": {"ipv4_address": 0}})
    paintball.engine.initiate_event("entity_registered", {"entity": {"ipv4_address": 1}})
    paintball.engine.initiate_event("entity_registered", {"entity": {"ipv4_address": 2}})
    paintball.engine.initiate_event("entity_registered", {"entity": {"ipv4_address": 3}})
    time.sleep(1)
